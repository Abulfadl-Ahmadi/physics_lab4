...
\begin{tabular}{ll}
    ...
    {\bf Teaching Assistants (TAs):} & Yasin Amiri \\
    & Sonia \\
\end{tabular}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{VH_vs_I_errorbars.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Vx_vs_I_errorbars.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{B_vs_Im_errorbars.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Vx_vs_VH_errorbars.pdf}
